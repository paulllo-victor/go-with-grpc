...
type CategoryGetResquest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *CategoryGetResquest) Reset() {
	*x = CategoryGetResquest{}
	mi := &file_proto_course_category_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CategoryGetResquest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CategoryGetResquest) ProtoMessage() {}

func (x *CategoryGetResquest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_course_category_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CategoryGetResquest.ProtoReflect.Descriptor instead.
func (*CategoryGetResquest) Descriptor() ([]byte, []int) {
	return file_proto_course_category_proto_rawDescGZIP(), []int{4}
}

func (x *CategoryGetResquest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"categories\"%\n" +
	"\x13CategoryGetResquest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id2\xd4\x02\n" +
	...
	"\x0eListCategories\x12\t.pb.blank\x1a\x10.pb.CategoryList\"\x00\x126\n" +
	"\vGetCategory\x12\x17.pb.CategoryGetResquest\x1a\f.pb.Category\"\x00B\rZ\vinternal/pbb\x06proto3"
...
var file_proto_course_category_proto_goTypes = []any{
	...
	(*CategoryGetResquest)(nil),   // 4: pb.CategoryGetResquest
}
var file_proto_course_category_proto_depIdxs = []int32{
	...
	4, // 5: pb.CategoryService.GetCategory:input_type -> pb.CategoryGetResquest
